...
public class Main {
    public static void main(String[] args) {
        SpringApplication.run(Main.class, args);       // SpringApplication.run() — это статический метод класса SpringApplication, который запускает приложение Spring при старте
    }
}
